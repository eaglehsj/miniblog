...
<head>
<title>Atomic_www.cssmoban.com模板之家</title>
...
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo"><h1><a href="index.jsp">Smart<span>Link</span></a> <small>put your slogan here</small></h1></div>
      <div class="clr"></div>
    </div>
  </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p><span class="date">sep 11, 2018</span> Posted by <a href="#">Owner</a> &nbsp;|&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a>, with <a href="#" class="com">11 Comments</a></p>
          <h2><span>Template</span> License</h2><div class="clr"></div>
          <img src="images/img1.jpg" width="625" height="205" alt="image" />
          <p>This is a free CSS website collect from <a href="http://www.cssmoban.com/" title="模板之家">模板之家</a>. This 
work is distributed under the Creative Commons Attribution 3.0 License, 
which means that you are free to use it for any personal or commercial purpose provided you credit me in the form of a link back to www.cssmoban.com.</p>
          <p class="spec"><a href="#" class="rm">Read more &raquo;</a></p>
        </div>
        <div class="article">
          <p><span class="date">aug 29, 2010</span> Posted by <a href="#">Owner</a> &nbsp;|&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a>, with <a href="#" class="com">7 Comments</a></p>
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">&copy; Copyright <a href="#">MyWebSite</a>. Collect From <a href="http://www.cssmoban.com/" title="网页模板">网页模板</a></p>
